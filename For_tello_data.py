...
image_path = r"D:\Machine_Learning\pythonProject\Tello_Photo\1697179731066.png"
folder_path = r"D:\Machine_Learning\pythonProject\Tello_Photo"
video_path = r"D:\Machine_Learning\pythonProject\test.mp4"
model_weights_path = r"D:\Machine_Learning\pythonProject\tello_weights\best.pt"
...
### For Folder
    ...
    if folder_path and os.path.exists(folder_path):
        image_files = [os.path.join(folder_path, filename) for filename in os.listdir(folder_path) if filename.lower().endswith((".jpg", ".jpeg", ".png"))]
...
### For video file
    ...
    if uploaded_video:
        ...
        if st.button("Detect Objects"):
            ...
            model = YOLO(r"D:\Machine_Learning\pythonProject\tello_weights\best.pt")
